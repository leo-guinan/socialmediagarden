...
import { ArrowLongLeftIcon, HomeIcon, MagnifyingGlassIcon } from "@heroicons/react/20/solid"
...
const Header = () => {
  ...
  const user = {
    name: 'Leo Guinan',
    email: 'leo@socialmediagarden.com',
    imageUrl:
      'https://pbs.twimg.com/profile_images/1547929810046840836/AQDnpT0a_400x400.png',
  }
  const navigation = [
    { name: 'Your Garden', href: '#' },
    { name: 'Garden Tools', href: '#' },
  ]
  const breadcrumbs = [
    { name: 'Your Garden', href: '#', current: false },
    { name: 'Terri Shubilla', href: '#', current: true },
  ]
